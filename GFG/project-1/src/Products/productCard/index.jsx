...
const ProductCard=({product})=>
{
  ...
  return (
    <Col lg={{span:4}} md={{span:5, offset:0}} sm={{span:10, offset:1}} >
    <Card className="product mb-4" >
      ...
      <CardBody className="content">
        ...
        {/* <section className='product-text'>{rating.rate}</section> */}
        ...
        <Rating
          ...
          size={20}
        />
        <Badge pill bg='primary' className="align-self-end mx-1">
          {rating.count}
